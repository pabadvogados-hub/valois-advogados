...
processual, e trabalha em conjunto com o Dr. Welington Dias Valois, inscrita na OAB/ES 34.912,
do escritorio Welington Valois Advogados Associados.
...
especializados em `.claude/agents/valois-*.md` (tambem disponiveis em
`agentes_claude/` para uso no Claude.ai): `valois-previdenciario.md` /
`valois-iniciais.md` / `valois-quesitos.md` (Previdenciario, calibrados
com material real do Dr. Welington) e `valois-trabalhista.md` /
`valois-bancario.md` (bases genericas, pendentes de calibracao). Esta
