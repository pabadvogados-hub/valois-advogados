# Regras de Compliance Juridica - Welington Valois Advogados Associados
...
## Direitos Previdenciarios a Validar (area principal - Dr. Welington)
...
## Direitos Trabalhistas a Validar (area de expansao - base generica, ver agentes_claude/valois-trabalhista.md)
...
## Direito Bancario / Defesa do Consumidor a Validar (area de expansao - base generica, ver agentes_claude/valois-bancario.md)
...
> pendentes de calibracao com pecas reais do Dr. Welington). Ajustar o rol
> de verificacao conforme a area do caso. Abrangencia geografica: Iúna/ES e
> Irupi/ES.
