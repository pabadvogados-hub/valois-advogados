...
5. Renderiza no timbrado do escritorio com formatacao FIEL:
   - Segoe UI 12pt (citacoes 11pt italico)
...
### B) Pelo agente operacional (VALOIS.IA)
...
├── escritorio_format.py         # formatador fiel (Segoe UI 12, recuo 1,25cm, etc)
...
- Segoe UI (corpo 12pt | citacoes 11pt italico)
- Paragrafos com recuo de 1a linha 1,25cm literais
...
- Recuo de 1a linha 1,25cm (provisorio - confirmar)
