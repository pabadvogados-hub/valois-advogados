"""Constantes e configuracao do Agente Operacional - Welington Valois Advogados Associados.
...
# ADVBOX
# ============================================================
# ID do usuario-agente (VALOIS.IA) no ADVBOX - a conta a quem as tarefas sao atribuidas.
...
# referenciando a tarefa original (ex: "[VALOISIA-FEITO #12345]"), NAO refaz o trabalho.
...
MARCADOR_CONCLUSAO = 'VALOISIA-FEITO'
...
ESCRITORIO_CIDADE = os.getenv('ESCRITORIO_CIDADE', 'Iúna/ES, Ibatiba/ES e Irupi/ES')
# Assinatura padrao das pecas geradas (previdenciario - Dr. Welington).
