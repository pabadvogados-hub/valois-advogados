...
Especificacoes (padrao do escritorio):
  Pagina A4
  Margens: 2,54cm em todos os lados (as do timbrado do escritorio)
  Fonte: Segoe UI
  Corpo: 12 pt
  Citacoes: 11 pt italico
  Espacamento entre linhas: 1.15
  Recuo 1a linha do corpo: 1,25 cm (padrao provisorio - CONFIRMAR com o escritorio)
...
TAM_CORPO = Pt(12)
TAM_CITACAO = Pt(11)
RECUO_PRIMEIRA = Cm(1.25)       # provisorio: confirmar com o escritorio
