#!/bin/bash
# =============================================================
#  VERIFICACAO DOS SERVICOS (macOS/Linux) - AGENTE OPERACIONAL (VALOIS.IA)
#  Equivalente ao verificar_servicos.bat (Windows).
# =============================================================

echo ""
echo "============================================================"
echo "  VERIFICACAO DOS SERVICOS - AGENTE OPERACIONAL (VALOIS.IA)"
echo "  $(date)"
echo "============================================================"
echo ""

echo "[1/4] AGENTE OPERACIONAL (porta 8787)..."
if curl -s -m 3 http://localhost:8787/healthcheck > /tmp/_valois_advogados_health.json 2>/dev/null; then
  echo "      OK    -> $(cat /tmp/_valois_advogados_health.json)"
else
