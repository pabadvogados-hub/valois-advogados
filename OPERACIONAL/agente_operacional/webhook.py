...
N8N monitora tarefas ADVBOX atribuidas ao usuario-agente (VALOIS.IA) e dispara:
...
app = FastAPI(title='Agente Operacional VALOIS_ADVOGADOS', version='1.0')
...
@app.get('/healthcheck')
def healthcheck():
    return {'status': 'ok', 'servico': 'agente_operacional_valois_advogados'}
