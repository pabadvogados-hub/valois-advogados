"""
=============================================================================
  SQUAD OPERACIONAL - WELINGTON VALOIS ADVOGADOS ASSOCIADOS
=============================================================================
  ...
  Uso:
    cd "AUTOMACOES VALOIS_ADVOGADOS" && python OPERACIONAL/main.py tarefas
    cd "AUTOMACOES VALOIS_ADVOGADOS" && python OPERACIONAL/main.py processos
    cd "AUTOMACOES VALOIS_ADVOGADOS" && python OPERACIONAL/main.py prazos
    cd "AUTOMACOES VALOIS_ADVOGADOS" && python OPERACIONAL/main.py gerar-peca <lawsuit_id>
    cd "AUTOMACOES VALOIS_ADVOGADOS" && python OPERACIONAL/main.py gerar-peticao "C:\\pasta_do_cliente"
...
def _headers():
    ...
    return {
        ...
        'User-Agent': 'VALOIS_ADVOGADOS-Advocacia/1.0',
    }
...
def cmd_tarefas(args):
    print('=' * 80)
    print('  TAREFAS PENDENTES - WELINGTON VALOIS ADVOGADOS ASSOCIADOS')
    print('=' * 80)
...
def cmd_processos(args):
    print('=' * 80)
    print('  PROCESSOS ATIVOS - WELINGTON VALOIS ADVOGADOS ASSOCIADOS')
    print('=' * 80)
...
def main():
    parser = argparse.ArgumentParser(description='Squad Operacional - Welington Valois Advogados Associados')
