"""
=============================================================================
  PROTOCOLO DE ENTREGA E RECEBIMENTO DE DOCUMENTOS - WELINGTON VALOIS ADVOGADOS ASSOCIADOS
=============================================================================
...
# ============================================================
ESCRITORIO = {
    'nome': os.getenv('ESCRITORIO_NOME', 'WELINGTON VALOIS ADVOGADOS ASSOCIADOS'),
    'advogada': os.getenv('ESCRITORIO_ADVOGADO', 'Dr. Welington Dias Valois'),
    'oab': os.getenv('ESCRITORIO_OAB', 'OAB/ES 34.912'),
    'endereco': os.getenv('ESCRITORIO_CIDADE', 'Iúna/ES'),
}
...
def executar_protocolo(args):
    ...
    print('\n' + '=' * 70)
    print('  PROTOCOLO DE ENTREGA/RECEBIMENTO - WELINGTON VALOIS ADVOGADOS ASSOCIADOS')
    print('=' * 70)
...
def main():
    parser = argparse.ArgumentParser(
        description='Protocolo de Entrega/Recebimento de Documentos - Welington Valois Advogados Associados'
    )
