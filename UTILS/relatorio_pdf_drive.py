...
Welington Valois Advogados Associados.
...
def _selftest():
    ...
    with open(html, 'w', encoding='utf-8') as fh:
        fh.write('<!doctype html><meta charset=utf-8>'
                 '<h1 style="font-family:sans-serif;color:#b8923f">VALOIS_ADVOGADOS selftest</h1>'
...
def main():
    ap = argparse.ArgumentParser(description='HTML -> PDF -> Google Drive (VALOIS_ADVOGADOS)')
